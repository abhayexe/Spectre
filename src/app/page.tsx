            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col">
                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900 dark:text-white">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5 flex-none text-indigo-600 dark:text-indigo-400">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                  ...
                  <p className="mt-6">
                    <Link href="/specs" className="text-sm font-semibold leading-6 text-indigo-600 dark:text-indigo-400">
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                  ...
                  <p className="mt-6">
                    <Link href="/automatic-specs" className="text-sm font-semibold leading-6 text-indigo-600 dark:text-indigo-400">
              ...
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                  ...
                  <p className="mt-6">
                    <Link href="/manual-specs" className="text-sm font-semibold leading-6 text-indigo-600 dark:text-indigo-400">
