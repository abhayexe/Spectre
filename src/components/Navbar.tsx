    ...
    Spectre
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                ...
                <button
                  ...
                  className="rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
          ...
          <Disclosure.Panel className="sm:hidden">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pb-3 pt-4">
              <div className="flex items-center px-4">
                ...
                <button
                  onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                  className="ml-auto rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 dark:bg-gray-700 dark:text-gray-300 dark:hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                  <span className="sr-only">Toggle dark mode</span>
                  {theme === 'dark' ? (
                    <SunIcon className="h-6 w-6" aria-hidden="true" />
